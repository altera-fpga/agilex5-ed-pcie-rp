...
# Example Usage with optional named option: perl sm_hps_modify.pl qsys_top.v qsys_top_mod.v --cct_prefix=ace5lite_cache_coherency_translator_0_m_ace5lite
...
GetOptions(
    'cct_prefix=s'  => \$cct_prefix
    #'count=i' => \$count,
) or die "Error in command line arguments\n";

if (defined $cct_prefix) {
  print "cct_prefix option is defined as: \n";
  print "$cct_prefix \n";
}
...
while(<$read_fh>)
{
  ...
  if($_ =~ m/module qsys_top \(/)
   {
      ...
      if (defined $cct_prefix) {
        # use defined cct_prefix
 	  print $write_fh "        // cache_coherency_translator interface\n";            
	  print $write_fh "        output wire    [7:0] ${cct_prefix}_wuser,\n";            
	  print $write_fh "        output wire   [10:0] ${cct_prefix}_awstashnid,\n";       
	  print $write_fh "        output wire    [3:0] ${cct_prefix}_arsnoop,\n";          
	  print $write_fh "        output wire    [3:0] ${cct_prefix}_awsnoop,\n";          
	  print $write_fh "        output wire   [31:0] ${cct_prefix}_wstrb,\n";            
	  print $write_fh "        input  wire          ${cct_prefix}_wready,\n";           
	  print $write_fh "        input  wire    [4:0] ${cct_prefix}_rid,\n";              
	  print $write_fh "        output wire          ${cct_prefix}_rready,\n";           
	  print $write_fh "        output wire    [7:0] ${cct_prefix}_awlen,\n";            
	  print $write_fh "        output wire    [3:0] ${cct_prefix}_awqos,\n";            
	  print $write_fh "        output wire    [3:0] ${cct_prefix}_arcache,\n";          
	  print $write_fh "        output wire    [2:0] ${cct_prefix}_arprot,\n";           
	  print $write_fh "        output wire  [255:0] ${cct_prefix}_wdata,\n";            
	  print $write_fh "        output wire          ${cct_prefix}_arvalid,\n";          
	  print $write_fh "        output wire    [4:0] ${cct_prefix}_arid,\n";             
	  print $write_fh "        output wire          ${cct_prefix}_arlock,\n";           
	  print $write_fh "        output wire          ${cct_prefix}_awlock,\n";           
	  print $write_fh "        input wire    [1:0]  ${cct_prefix}_bresp,\n";             
	  print $write_fh "        input wire           ${cct_prefix}_arready,\n";           
	  print $write_fh "        output wire    [2:0] ${cct_prefix}_arsize,\n";           
	  print $write_fh "        output wire    [1:0] ${cct_prefix}_awdomain,\n";         
	  print $write_fh "        output wire          ${cct_prefix}_bready,\n";           
	  print $write_fh "        output wire          ${cct_prefix}_wlast,\n";            
	  print $write_fh "        output wire    [3:0] ${cct_prefix}_awregion,\n";         
	  print $write_fh "        input wire    [7:0]  ${cct_prefix}_buser,\n";             
	  print $write_fh "        input wire    [1:0]  ${cct_prefix}_rresp,\n";             
	  print $write_fh "        input wire           ${cct_prefix}_bvalid,\n";            
	  print $write_fh "        input wire    [7:0]  ${cct_prefix}_ruser,\n";             
	  print $write_fh "        output wire    [1:0] ${cct_prefix}_awburst,\n";          
	  print $write_fh "        output wire    [3:0] ${cct_prefix}_arregion,\n";         
	  print $write_fh "        output wire          ${cct_prefix}_awstashlpiden,\n";    
	  print $write_fh "        output wire          ${cct_prefix}_awstashniden,\n";     
	  print $write_fh "        output wire    [7:0] ${cct_prefix}_arlen,\n";            
	  print $write_fh "        output wire    [3:0] ${cct_prefix}_arqos,\n";            
	  print $write_fh "        output wire    [7:0] ${cct_prefix}_awuser,\n";           
	  print $write_fh "        output wire    [5:0] ${cct_prefix}_awatop,\n";           
	  print $write_fh "        output wire          ${cct_prefix}_wvalid,\n";           
	  print $write_fh "        output wire   [35:0] ${cct_prefix}_araddr,\n";           
	  print $write_fh "        output wire    [2:0] ${cct_prefix}_awprot,\n";           
	  print $write_fh "        output wire    [3:0] ${cct_prefix}_awcache,\n";          
	  print $write_fh "        output wire   [35:0] ${cct_prefix}_awaddr,\n";           
	  print $write_fh "        output wire    [4:0] ${cct_prefix}_awstashlpid,\n";      
	  print $write_fh "        input wire  [255:0]  ${cct_prefix}_rdata,\n";             
	  print $write_fh "        input wire           ${cct_prefix}_awready,\n";           
	  print $write_fh "        output wire    [1:0] ${cct_prefix}_arburst,\n";          
	  print $write_fh "        input wire           ${cct_prefix}_rlast,\n";             
	  print $write_fh "        output wire    [1:0] ${cct_prefix}_ardomain,\n";         
	  print $write_fh "        output wire    [4:0] ${cct_prefix}_awid,\n";             
	  print $write_fh "        input wire    [4:0]  ${cct_prefix}_bid,\n";               
	  print $write_fh "        output wire    [2:0] ${cct_prefix}_awsize,\n";           
	  print $write_fh "        output wire          ${cct_prefix}_awvalid,\n";          
	  print $write_fh "        input wire           ${cct_prefix}_rvalid,\n";            
	  print $write_fh "        output wire    [7:0] ${cct_prefix}_aruser,\n";           
          print $write_fh "\n";     
        } else {
	  print $write_fh "        // cache_coherency_translator interface\n";            
  ...
  elsif($_ =~ m/(wire (.*) altera_ace5lite_cache_coherency_translator_0_m0(.*))|(wire (.*) subsys_hps_hps2fpga_(.*))|(wire (.*) subsys_hps_lwhps2fpga_(.*))|(wire (.*) ${cct_prefix}_(.*))/
        )
   {
      print $write_fh "    `ifdef SM_RP_SIM_ENABLE \n";
      print $write_fh "    // $_";
