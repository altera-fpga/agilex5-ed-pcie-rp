  ...
  function void setup_pcie_device_system_defaults();
    begin
	 ...
	 endpoint_cfg.pcie_cfg.pl_cfg.enable_sris_elastic_buffer_mode = 1;
      ...
      //endpoint_cfg.pcie_cfg.pl_cfg.set_link_eq_attribute_values(svt_pcie_pl_configuration::LINK_EQ_MODE_NO_EQUALIZATION_NEEDED,1,0);
      endpoint_cfg.pcie_cfg.pl_cfg.set_link_eq_attribute_values(,1,0);


      endpoint_cfg.driver_cfg[0].requester_id = 'h100;  //By default Requester ID was set as 'h001 
      ...
      //Refer article for further details :https://solvnetplus.synopsys.com/s/article/VC-VIP-Understanding-UVM-Warning-Message-Regarding-Shadow-Memory-Configuration-in-the-PCIe-VIP-1576092580603. 
