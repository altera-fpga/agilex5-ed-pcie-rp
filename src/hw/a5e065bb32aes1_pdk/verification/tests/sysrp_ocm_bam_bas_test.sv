/**
 * Abstract:  sysrp_ocm_bam_bas_test
...
class sysrp_ocm_bam_bas_test extends sysrp_base_test;
  ...
  `uvm_component_utils(sysrp_ocm_bam_bas_test)

  /** Class Constructor */
  function new(string name = "sysrp_ocm_bam_bas_test", uvm_component parent=null);
  ...
  virtual function void build_phase(uvm_phase phase);
   ...
   `uvm_info ("build_phase", "[sysrp_ocm_bam_bas_test] Entered Build Phase...",UVM_LOW);
    super.build_phase(phase);

    uvm_config_db #(int)::set(null,"*","sequence_length",120);
   `uvm_info ("build_phase", "[sysrp_ocm_bam_bas_test] Exiting Build Phase...",UVM_LOW)
  ...
  task run_phase(uvm_phase phase);
    sysrp_ocm_bam_bas_seq m_seq;

    super.run_phase(phase);
    phase.raise_objection(this);

    //uvm_config_db#(int)::get(null, "", "sequence_length", sequence_length);
    m_seq = sysrp_ocm_bam_bas_seq::type_id::create("m_seq");
