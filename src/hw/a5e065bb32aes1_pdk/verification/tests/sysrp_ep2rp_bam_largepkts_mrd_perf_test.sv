/**
 * Abstract:  sysrp_ep2rp_bam_largepkts_mrd_perf_test
...
class sysrp_ep2rp_bam_largepkts_mrd_perf_test extends sysrp_base_test;
  int sequence_length ;
  int pcie_tx_scbd;
  int axi_tx_scbd;

  /** UVM Component Utility macro */
  `uvm_component_utils(sysrp_ep2rp_bam_largepkts_mrd_perf_test)

  /** Class Constructor */
  function new(string name = "sysrp_ep2rp_bam_largepkts_mrd_perf_test", uvm_component parent=null);
  ...
  virtual function void build_phase(uvm_phase phase);
   ...
   `uvm_info ("build_phase", "[sysrp_ep2rp_bam_largepkts_mrd_perf_test] Entered Build Phase...",UVM_LOW);
    super.build_phase(phase);

    uvm_config_db #(int)::set(null,"*","sequence_length",120);
   `uvm_info ("build_phase", "[sysrp_ep2rp_bam_largepkts_mrd_perf_test] Exiting Build Phase...",UVM_LOW)
  ...
  task run_phase(uvm_phase phase);
    sysrp_ep2rp_bam_largepkts_mrd_perf_seq m_seq;

    super.run_phase(phase);
    phase.raise_objection(this);

    m_seq = sysrp_ep2rp_bam_largepkts_mrd_perf_seq::type_id::create("m_seq");
