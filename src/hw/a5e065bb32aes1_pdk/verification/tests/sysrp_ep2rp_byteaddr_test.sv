/**
 * Abstract:  sysrp_ep2rp_byteaddr_test
 ...
 */
class sysrp_ep2rp_byteaddr_test extends sysrp_base_test;
  ...
  `uvm_component_utils(sysrp_ep2rp_byteaddr_test)

  /** Class Constructor */
  function new(string name = "sysrp_ep2rp_byteaddr_test", uvm_component parent=null);
  ...
  virtual function void build_phase(uvm_phase phase);
   ...
   `uvm_info ("build_phase", "[sysrp_ep2rp_byteaddr_test] Entered Build Phase...",UVM_LOW);
    super.build_phase(phase);

    uvm_config_db #(int)::set(null,"*","sequence_length",10);
   `uvm_info ("build_phase", "[sysrp_ep2rp_byteaddr_test] Exiting Build Phase...",UVM_LOW)
  ...
  task run_phase(uvm_phase phase);
    sysrp_ep2rp_byteaddr_seq m_seq;

    super.run_phase(phase);
    phase.raise_objection(this);

    uvm_config_db#(int)::get(null, "", "sequence_length", sequence_length);
    m_seq = sysrp_ep2rp_byteaddr_seq::type_id::create("m_seq");
