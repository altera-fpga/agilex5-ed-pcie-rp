/**
 * Abstract:  sysrp_ep2rp_bam_expandedmem_test
...
class sysrp_ep2rp_bam_expandedmem_test extends sysrp_base_test;
  ...
  `uvm_component_utils(sysrp_ep2rp_bam_expandedmem_test)

  /** Class Constructor */
  function new(string name = "sysrp_ep2rp_bam_expandedmem_test", uvm_component parent=null);
  ...
  virtual function void build_phase(uvm_phase phase);
   ...
   `uvm_info ("build_phase", "[sysrp_ep2rp_bam_expandedmem_test] Entered Build Phase...",UVM_LOW);
    super.build_phase(phase);

    uvm_config_db #(int)::set(null,"*","sequence_length",120);
   `uvm_info ("build_phase", "[sysrp_ep2rp_bam_expandedmem_test] Exiting Build Phase...",UVM_LOW)
  ...
  task run_phase(uvm_phase phase);
    sysrp_ep2rp_bam_expandedmem_seq m_seq;

    super.run_phase(phase);
    phase.raise_objection(this);

    m_seq = sysrp_ep2rp_bam_expandedmem_seq::type_id::create("m_seq");
    m_seq.randomize() with {m_seq.sequence_length==40;};
