/**
 * Abstract: sysrp_basic_avmm_bas_b2b_test 
...
class sysrp_basic_avmm_bas_b2b_test extends sysrp_base_test;
   int sequence_length ;
   int pcie_tx_scbd;
   int axi_tx_scbd;

   /** UVM Component Utility macro */
   `uvm_component_utils(sysrp_basic_avmm_bas_b2b_test)

   /** Class Constructor */
   function new(string name = "sysrp_basic_avmm_bas_b2b_test", uvm_component parent=null);
   ...
   virtual function void build_phase(uvm_phase phase);
     ...
     `uvm_info ("build_phase", "[sysrp_basic_avmm_bas_b2b_test] Entered Build Phase...",UVM_LOW);
     super.build_phase(phase);

     `uvm_info ("build_phase", "[sysrp_basic_avmm_bas_b2b_test] Exiting Build Phase...",UVM_LOW)
  ...
  task run_phase(uvm_phase phase);
     sysrp_basic_avmm_bas_b2b_seq m_seq;

     super.run_phase(phase);
     phase.raise_objection(this);

     m_seq = sysrp_basic_avmm_bas_b2b_seq::type_id::create("m_seq");
