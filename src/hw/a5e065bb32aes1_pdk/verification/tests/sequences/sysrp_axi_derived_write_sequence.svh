...
class sysrp_axi_derived_write_sequence extends svt_axi_master_base_sequence;

  `svt_xvm_declare_p_sequencer(svt_axi_master_sequencer)
  `svt_xvm_object_utils(sysrp_axi_derived_write_sequence)
  ...
  function new(string name="sysrp_axi_derived_write_sequence");
    super.new(name);
  endfunction
...
endclass: sysrp_axi_derived_write_sequence
