/**
 * Abstract: sysrp_b2b_avmm_bam_unalligned_test 
...
class sysrp_b2b_avmm_bam_unalligned_test extends sysrp_base_test;
   int sequence_length ;
   int pcie_tx_scbd;
   int axi_tx_scbd;

   /** UVM Component Utility macro */
   `uvm_component_utils(sysrp_b2b_avmm_bam_unalligned_test)


   /** Class Constructor */
   function new(string name = "sysrp_b2b_avmm_bam_unalligned_test", uvm_component parent=null);
   ...
   virtual function void build_phase(uvm_phase phase);
      ...
      `uvm_info ("build_phase", "[sysrp_b2b_avmm_bam_unalligned_test] Entered Build Phase...",UVM_LOW);
      ...
      `uvm_info ("build_phase", "[sysrp_b2b_avmm_bam_unalligned_test] Exiting Build Phase...",UVM_LOW)
   endfunction: build_phase


   task run_phase(uvm_phase phase);
      sysrp_b2b_avmm_bam_unalligned_seq m_seq;

      super.run_phase(phase);
      phase.raise_objection(this);

      uvm_config_db#(int)::get(null, "", "sequence_length", sequence_length);
      m_seq = sysrp_b2b_avmm_bam_unalligned_seq::type_id::create("m_seq");
