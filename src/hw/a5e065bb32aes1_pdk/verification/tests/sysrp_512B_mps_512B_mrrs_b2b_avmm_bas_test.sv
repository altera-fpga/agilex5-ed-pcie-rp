/**
 * Abstract: sysrp_512B_mps_512B_mrrs_b2b_avmm_bas_test 
 * Perform transactions from HPS to EP with MPS=512bytes and MRRS=512bytes
 */

 class sysrp_512B_mps_512B_mrrs_b2b_avmm_bas_test extends sysrp_base_test;
    int RP_MPS_value ;
    int EP_MPS_value ;
    int MRRS_value ;
    int pcie_tx_scbd;
    ...
    `uvm_component_utils(sysrp_512B_mps_512B_mrrs_b2b_avmm_bas_test)

    /** Class Constructor */
    function new(string name = "sysrp_512B_mps_512B_mrrs_b2b_avmm_bas_test", uvm_component parent=null);
    ...
    virtual function void build_phase(uvm_phase phase);
       ...
       pcie_tx_scbd = 0;
       axi_tx_scbd  = 1;
       `uvm_info ("build_phase", "[sysrp_512B_mps_512B_mrrs_b2b_avmm_bas_test] Entered Build Phase...",UVM_LOW);
       ...
       `uvm_info ("build_phase", "[sysrp_512B_mps_512B_mrrs_b2b_avmm_bas_test] Exiting Build Phase...",UVM_LOW)
